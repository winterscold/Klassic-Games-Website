    ...
    */
    ...
    document.getElementById(mode).addEventListener('click', function () { snakeSpeed = speed; });
        ...
        */
        ...
        //save score and show save button
        function saveScore() {
            //save score to HTML
            document.getElementById('scoreButton').value = me.snakeLength;
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            var playButtonText = document.createTextNode("Play Game");
            //playButtonText.setAttribute("STYLE","color:blue");
            welcomeStart.appendChild(playButtonText);
